...
import GreenerAbout from "./../../pages/Greeners/GreenerAbout";
                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-10">
                      ...
                      <div>
                        ...
                        <h3 className="text-[22px] leading-9 font-bold text-head">{data.name}</h3>
                    ...
                    <GreenerAbout name={data.name} about={data.about} qualifications={data.qualifications} experiences={data.experiences} />
                  </div>
                )}
                {tab === "appointments" && <Appointments appointments={data.appointments} />}
                {tab === "settings" && <Profile greenerData={data} />}
              </div>
            </div>
          </div>
        )}
